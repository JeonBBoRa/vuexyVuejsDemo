<template>
  <div id="dashboard-live">
    <div class="vx-row">
      <div class="vx-col w-full md:w-1/2" id="img1">
        <vx-card :title="`CCTV_${cctv1} Live`" slot="no-body">
          <div class="mt-5">
...
<!--<style scoped>-->
<style>
#img1{height: 50vh; min-height: 50vh; margin-bottom: 3vh;}
#img2{height: 45vh; margin-bottom: 3vh;}
//#crt1{height: 30vh}
#crt1{height: 50vh; min-height: 50vh; margin-bottom: 3vh;}
#crt2{height: 30vh}
.router-view{padding-top: 1rem;}
.vx-card{min-height: 50vh}
</style>
